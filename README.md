...
- Server-side syntax highlighting for code blocks
   - Supported languages: Nim, Rust, C++, C#, C, GDScript, Java, Javascript, Yaml, Python, Console
...
Environment="NOIRE_HOSTNAME=your-domain.tld" # used for atom feed links primarily
